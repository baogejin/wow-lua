...
local RequireToken = true
local TokenEntry = 29460
local TokenAmount = 1
...
local Locales = {
    {"更新目录", nil, nil, nil, nil, nil, nil, nil, nil},
    {"移除所有幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"从所有装备中移除幻化?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"使用此物品幻化将绑定到您，并使其不可退款和不可交易。 您要继续吗?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s 移除幻化?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"返回..", nil, nil, nil, nil, nil, nil, nil, nil},
    {"移除幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"从装备的物品中移除幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"你背包里没有幻化物品", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s 幻化已移除", nil, nil, nil, nil, nil, nil, nil, nil},
    {"未发现 %s 的幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s 幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"所选装备不可用", nil, nil, nil, nil, nil, nil, nil, nil},
    {"所选装备不存在", nil, nil, nil, nil, nil, nil, nil, nil},
    {"您身上无此部位的装备", nil, nil, nil, nil, nil, nil, nil, nil},
    {"你的钱不够 %ss", nil, nil, nil, nil, nil, nil, nil, nil},
...
local function SuitableForTransmogrification(player, transmogrified, transmogrifier)
    ...
    if fierClass ~=fiedClass or fierSubClass~=fiedSubClass then
        return false
    end
...
local function OnGossipHello(event, player, creature)
    ...
    player:GossipSendMenu(8, creature, menu_id)
end
